...
var ReactCardFlip = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "react-card-flip", style: __assign(__assign({}, styles.container), containerStyle) },
        react_1.default.createElement("div", { className: "react-card-flipper", style: styles.flipper },
            react_1.default.createElement("div", { className: "react-card-front", style: styles.front }, getComponent(0)),
            react_1.default.createElement("div", { className: "react-card-back", style: styles.back }, getComponent(1)))));
};
